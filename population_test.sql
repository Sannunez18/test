...
LOAD DATA LOCAL INFILE '/sql_project/data_csv/dueño.csv'
INTO TABLE DUENO
FIELDS TERMINATED BY ','  ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
LOAD DATA  LOCAL INFILE '/sql_project/data_csv/talleres.csv'
INTO TABLE TALLER
FIELDS TERMINATED BY ','  ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
LOAD DATA  LOCAL INFILE '/sql_project/data_csv/puesto_trabajo_taller.csv'
